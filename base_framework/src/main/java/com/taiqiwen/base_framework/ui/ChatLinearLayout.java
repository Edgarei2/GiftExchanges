...
public class ChatLinearLayout extends LinearLayout {
    ...
    public ChatLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public ChatLinearLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
